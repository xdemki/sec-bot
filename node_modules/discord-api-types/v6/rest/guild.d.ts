...
export declare type APIGuildCreatePartialChannel = Partial<Pick<APIChannel, 'type' | 'permission_overwrites' | 'topic' | 'nsfw' | 'bitrate' | 'user_limit' | 'rate_limit_per_user' | 'parent_id'>> & Required<Pick<APIChannel, 'name'>>;
/**
 ...
 */
export declare type RESTPostAPIGuildChannelJSONBody = APIGuildCreatePartialChannel;
 ...
 */
export declare type RESTGetAPIGuildWidgetResult = APIGuildWidget;
/**
 * https://discord.com/developers/docs/resources/guild#modify-guild-widget
 */
export declare type RESTPatchAPIGuildWidgetJSONBody = Partial<APIGuildWidget>;
export declare type RESTPatchAPIGuildWidgetResult = APIGuildWidget;
/**
